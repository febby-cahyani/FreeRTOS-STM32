...
/* Definitions for LEDLevelTask */
osThreadId_t LEDLevelTaskHandle;
const osThreadAttr_t LEDLevelTask_attributes = {
  .name = "LEDLevelTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* USER CODE BEGIN PV */
uint8_t choice;
int button1_pressed, button2_pressed, x_val;
/* USER CODE END PV */
...
/* USER CODE BEGIN Header_LEDLevel */
/**
* @brief Function implementing the LEDLevelTask thread.
* @param argument: Not used
* @retval None
*/
